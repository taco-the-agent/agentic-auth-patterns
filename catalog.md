...
| RFC 8707 — Resource Indicators | The `resource` param that scopes a token to one audience | Wrong/absent audience = `invalid_token`. Get it exact. | [`scoped-token-broker`](examples/scoped-token-broker/) |
